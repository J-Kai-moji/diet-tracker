...
CREATE POLICY records_select ON meal_records FOR SELECT USING (true);
CREATE POLICY records_insert ON meal_records FOR INSERT WITH CHECK (true);
CREATE POLICY records_delete ON meal_records FOR DELETE USING (true);
...
(37, '肌酸',           '补剂',  0,    0,    0,    0,   'g', NULL, true);

SELECT setval('foods_id_seq', 37);
